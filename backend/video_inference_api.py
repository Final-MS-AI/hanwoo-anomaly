...
from feeding_inference_service import process_feeding_video_job


@router.post("/feeding-jobs")
async def create_feeding_inference_job(
    background_tasks: BackgroundTasks,
    video: UploadFile = File(...),
):
    extension = Path(
