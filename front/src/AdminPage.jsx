  ...
  return (
    <main className="admin-shell">
      <aside className="admin-sidebar">
        ...
        <div className="admin-workspace"><span className="workspace-dot" /> 한우 · 메인 워크스페이스</div>
